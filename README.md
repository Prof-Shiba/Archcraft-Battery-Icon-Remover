# Archcraft Battery Icon Remover
...
---
**⚠️ The script will automatically generate backups of all files it modifies. So in case anything goes wrong, you can revert everything.**
---
